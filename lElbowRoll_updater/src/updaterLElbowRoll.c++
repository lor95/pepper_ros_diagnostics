...
void posElbowroll_diagnostic(diagnostic_updater::DiagnosticStatusWrapper &stat){
	...
	} else if(((posElbowRoll0 < interval[0] && posElbowRoll0 > min_le_r) || (posElbowRoll0 > interval[1] && posElbowRoll0 < max_le_r)) || (velElbowRoll0 >= max_le_yv) || (effElbowRoll0 >= max_le_ye)){
