...
void posHead0_diagnostic(diagnostic_updater::DiagnosticStatusWrapper &stat){
    ...
    if(posHeadPitch0 <= (max_h_p*head_p_thr) && posHeadPitch0>(min_h_p*head_p_thr) && velHeadPitch0 <= (max_h_pv*head_v_thr) && effHeadPitch0 <= (max_h_pe*head_e_thr)) {
        stat.summary(diagnostic_msgs::DiagnosticStatus::OK,"OK");
    } else if((posHeadPitch0<max_h_y && posHeadPitch0>min_h_y) || velHeadPitch0<max_h_pv || effHeadPitch0<max_h_pe){
